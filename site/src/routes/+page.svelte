<script lang="ts">
	...
	const name = $derived(userState.user?.name || userState.user?.email || 'there');
</script>
...
{:else}
	<section class="hero">
		...
		<p class="lede">
			Klaxon watches the pages you care about — a court docket, an agency notice, a pricing page —
			and tells you when something changes. Set an alert, and we check on a schedule and capture the
			difference.
		</p>
		<div class="actions">
	...
	<section class="features">
		<div class="feature">
			...
			<p>Watch a whole page or just the region you pick with the browser extension.</p>
		</div>
		<div class="feature">
		...
		<div class="feature">
			...
			<p>Every detected change is archived with a visual diff so you can review the difference.</p>
		</div>
	</section>
{/if}
