...
<div class="edit-page">
  ...
  >
    ...
    <!-- Reads the selector field below, so it follows a hand-edit as it's typed
         — including to and from "the entire page" when the field is cleared. -->
    <p class="watching">
    ...
    <div class="field">
      <div class="field-header">
        ...
        {#if !wholePage}
          <p class="field-hint">
            The watched region was picked on the current page, so pointing this
            alert somewhere else may leave nothing for it to match.
          </p>
        {/if}
      </div>
      <input
    ...
    <!-- The selector is normally the picker's business, so it stays folded away
         — same status-row-plus-disclosure shape as ExtensionGuidance above. -->
    <section class="selector-panel">
      <div class="row">
        ...
        <p class="status">
          Klaxon records the watched region as a CSS selector.
        </p>
      ...
      <div class="details" id="selector-details" hidden={!selectorOpen}>
        ...
        <p class="field-hint" id="selector-hint">
          Klaxon watches whatever this selector matches; leave it empty to watch
          the whole page.
        </p>
        <textarea
          id="selector"
